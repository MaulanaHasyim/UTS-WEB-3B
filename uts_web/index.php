...
<body background="bc.png">
    <div class="wrap">
        ...
        <div class="header">          
            <h1><font face="Century Gothic">LearningWeb.id</font></h1>
            <div class="tanggal">
                <?php
                    // Real Time Clock
                    echo date('d F Y');
        ...
        <div class="content"><center>
            ...
            <h2>Selamat Datang di LearningWeb.id</h2>
            <table>
                <tr><td>Nama</td><td>:</td><td>Maulana Hasyim</td></tr>
                <tr><td>NIM</td><td>:</td><td>11180910000043</td></tr>
                <tr><td>Program Studi</td><td>:</td><td>Teknik Informatika 2018</td></tr>
                </table>
            ...
            <?php
				...
				<p>Tidak ada website yang aman</p>
